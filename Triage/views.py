...
def nivel_triage_lista(request):
    ...
    return render(request, 'plantillas/signos_vitales.html', {'niveles': niveles})
...
def nivel_triage_detalle(request, pk):
    ...
    return render(request, 'plantillas/signos_vitales.html', {'nivel': nivel})



# def colores(request):
#     opciones_colores = [(str(edad), str(edad)) for edad in range(18, 51)]
#     data = {
